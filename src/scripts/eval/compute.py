...
from neuron_analyzer.load_util import load_eval, sel_eval
...
def config_path(args, filename: str) -> tuple[Path, Path, Path]:
    """Initialize paths."""
    result_dir = settings.PATH.surprisal_dir / "base"
...
def save_results(args, results_df, result_dir: Path, result_file: Path, filename: str) -> None:
...
def main() -> None:
    ...
    # Generate filename for base surprisal
    ...
    logger.info("Computing base surprisal across training steps")
